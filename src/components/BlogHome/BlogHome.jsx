  ...
  return (
    <div className={`container ${CSS.blog_container}`}>
      ...
      <p className={CSS.blog_text}>
        ...
        in the conditions of financial crisis, when the purchasing power of the
        population is shrinking, inflation is rising, and currency exchange
        rates.
      </p>
      <img src={img2} alt="" />
      <Link>
      ...
      <p className={CSS.blog_text}>
        ...
        heads' of personnel management words, in order to find a personnel who
        will correspond to the relevant customer needs and requirements, it is
        necessary to carry out a great job.
      </p>
      <img src={img3} alt="" />
      <Link>
        <h3 className={CSS.blog_text_title}>
